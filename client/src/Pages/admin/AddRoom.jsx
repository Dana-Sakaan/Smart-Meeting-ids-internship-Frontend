...
import { FaArrowLeft, FaSave, FaDoorOpen, FaUsers,FaCloudUploadAlt, FaTimes } from "react-icons/fa";
...
const AddRoom = () => {
    ...
    const handleSubmit = async (e)=>{
      ...
      try {
        ...
        const res = await axios.post("/api/room", updatedRoomData, {withCredentials:true}) //add room
        const res2 = await axios.post(`/api/room/${res.data.id}/features` , {featureIDs:choosenFeatures}, {withCredentials:true}) // add features for this room
        setLoading(false)
          ...
          <div className="space-y-6">
              ...
              {roomData.image && (
                <div className="mt-4">
                  ...
                  <div className="relative w-40 h-40 border rounded-md overflow-hidden">
                    <img 
                      src={typeof roomData.image === 'string' ? roomData.image : URL.createObjectURL(roomData.image)} 
                      alt="Room preview" 
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                {roomFeatures.length>0 && roomFeatures.map(feature => (
                  <div key={feature.id} className="flex items-center">
                    ...
                    />
                    <label htmlFor={feature.id} className="ml-2 flex items-center text-sm text-gray-700 dark:text-gray-300">
                      {feature.feature}
                    </label>
                  </div>
                ))}
            ...
            <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Your wanted feature not found? Add new feature
              <Link to="/dashboard/addfeature" className="ml-1 text-indigo-600">Here</Link>
            </p>
          </div>
